<nav class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
    <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="sidebarMenuLabel">Fortino Blog</h5>
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            ...
            @can('admin')
            <h6 class="sidebar-heaeding d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
                <span>Administrator</span>
            </h6>
            <ul class="nav flex-column">
                <li class="nax-item">
                    <a class="nav-link d-flex align-items-center gap-2 {{ Request::is('dashboard/posts*') ? 'active' : ''}}" href="/dashboard/categories">
                        <svg class="bi">
                            <use xlink:href="#file-earmark" />
                        </svg>
                        Post Categories
